...
import { BrowserRouter as Router, Routes, Route, HistoryRouterProps } from 'react-router-dom'
import { navigate , history } from './hooks/navigation-context'; // Importe o history também
